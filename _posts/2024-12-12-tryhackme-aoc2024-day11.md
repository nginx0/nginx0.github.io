...
media_subpath: /images/tryhackme_aoc2024_day11/
image:
  path: banner.png
---
...
<details>
  ...
  <div style="padding:10px; border:1px solid #ccc;">
    <span onclick="navigator.clipboard.writeText('02:00:00:00:02:00')" style="cursor:pointer;">02:00:00:00:02:00</span>
    <i onclick="navigator.clipboard.writeText('02:00:00:00:02:00')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  <summary style="cursor:pointer; padding:10px; border:1px solid #ccc; background-color:#f0f0f0; user-select: none;">Answer</summary>
  <div style="padding:10px; border:1px solid #ccc;">
    <span onclick="navigator.clipboard.writeText('02:00:00:00:01:00')" style="cursor:pointer;">02:00:00:00:01:00</span>
    <i onclick="navigator.clipboard.writeText('02:00:00:00:01:00')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  <summary style="cursor:pointer; padding:10px; border:1px solid #ccc; background-color:#f0f0f0; user-select: none;">Answer</summary>
  <div style="padding:10px; border:1px solid #ccc;">
    <span onclick="navigator.clipboard.writeText('fluffy/champ24')" style="cursor:pointer;">fluffy/champ24</span>
    <i onclick="navigator.clipboard.writeText('fluffy/champ24')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
