---
title: "TryHackMe: Advent Of Cyber 2025 Day 12 (Phishing - Phishmas Greetings)"
categories: [TryHackMe]
tags: [phishing, dfir, advent of cyber]
render_with_liquid: false
media_subpath: /images/tryhackme_aoc2025_day12/
image:
  path: banner.png
---
...
[![TryHackMe Room Link](header.svg){: width="1200" height="407" }](https://tryhackme.com/room/spottingphishing-aoc2025-r2g4f6s8l0)
...
![](eggsploit.png){: width="1080" height="1080"}
...
![](phish.png){: width="1485" height="525"}
...
![](phish1.png){: width="1475" height="805"}

In the above screenshot, it's a sample marketing email offering logistics solutions for the SOC-mas event. We can observe that the intention behind the message is pure marketing. You need to be careful when analysing each message. **Look for the intention behind it**. Not every unwanted email is a threat; sometimes it’s just spam that poses no real risk to TBFC.
...
![](phish2.png){: width="1483" height="641"}
...
- **Impersonation:** A type of social engineering where the attacker pretends to be McSkidy.  
- **Sense of urgency:** Words like "urgent" and "immediately" are used to pressure the recipient.  
- **Side channel:** The attacker discourages the recipient from using McSkidy’s standard communication channels (phone or email).  
- **Malicious intention:** The attacker aims to trick the user into revealing VPN credentials, approving payments, opening malware, or sharing sensitive data.

![](phish3.png){: width="1482" height="641"}
...
![](typosquatting.png){: width="888" height="452"}
...
![](punycode.png){: width="632" height="375"}
...
![](latin.png){: width="1487" height="814"}
...
![](audio.png){: width="1477" height="483"}
...
![](head.png){: width="1433" height="418"}
...
![](attachments.png){: width="1465" height="194"}
...
![](trending.png){: width="1920" height="1080"}
...
![](share.png){: width="1510" height="733"}
...
![](fakelogin.png){: width="1917" height="965"}
...
![](side.png){: width="1508" height="429"}
...
>Check out this [technical analysis of SMTP smuggling and spoofing tactics](https://sec-consult.com/blog/detail/smtp-smuggling-spoofing-e-mails-worldwide/) to understand more.
{: .prompt-tip }
...
![](q1.png){: width="1420" height="303"}
![](q1_head.png){: width="1432x416" height="416"}
![](q1_return.png){: width="1433" height="418"}

**Email 2**

![](q2.png){: width="1432" height="303"}
![](q2_head.png){: width="1426" height="416"}
![](q2_return.png){: width="1369" height="191"}

**Email 3**

![](q3.png){: width="1430" height="298"}
![](q3_head.png){: width="1415" height="410"}

**Email 4**

![](q4.png){: width="1422" height="417"}

**Email 5**

![](q5.png){: width="1407" height="124"}

**Email 6**

![](q6.png){: width="1427" height="423"}
...
<details>
  ...
  <div style="padding:10px; border:1px solid #888; background-color:#333; color:#fff;">
    <span onclick="navigator.clipboard.writeText('THM{yougotnumber1-keep-it-going}')" style="cursor:pointer;">THM{yougotnumber1-keep-it-going}</span>
    <i onclick="navigator.clipboard.writeText('THM{yougotnumber1-keep-it-going}')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  ...
  <div style="padding:10px; border:1px solid #888; background-color:#333; color:#fff;">
    <span onclick="navigator.clipboard.writeText('THM{nmumber2-was-not-tha-thard!}')" style="cursor:pointer;">THM{nmumber2-was-not-tha-thard!}</span>
    <i onclick="navigator.clipboard.writeText('THM{nmumber2-was-not-tha-thard!}')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  ...
  <div style="padding:10px; border:1px solid #888; background-color:#333; color:#fff;">
    <span onclick="navigator.clipboard.writeText('THM{Impersonation-is-areal-thing-keepIt}')" style="cursor:pointer;">THM{Impersonation-is-areal-thing-keepIt}</span>
    <i onclick="navigator.clipboard.writeText('THM{Impersonation-is-areal-thing-keepIt}')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  ...
  <div style="padding:10px; border:1px solid #888; background-color:#333; color:#fff;">
    <span onclick="navigator.clipboard.writeText('THM{Get-back-SOC-mas!!}')" style="cursor:pointer;">THM{Get-back-SOC-mas!!}</span>
    <i onclick="navigator.clipboard.writeText('THM{Get-back-SOC-mas!!}')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  ...
  <div style="padding:10px; border:1px solid #888; background-color:#333; color:#fff;">
    <span onclick="navigator.clipboard.writeText('THM{It-was-just-a-sp4m!!}')" style="cursor:pointer;">THM{It-was-just-a-sp4m!!}</span>
    <i onclick="navigator.clipboard.writeText('THM{It-was-just-a-sp4m!!}')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  ...
  <div style="padding:10px; border:1px solid #888; background-color:#333; color:#fff;">
    <span onclick="navigator.clipboard.writeText('THM{number6-is-the-last-one!-DX!}')" style="cursor:pointer;">THM{number6-is-the-last-one!-DX!}</span>
    <i onclick="navigator.clipboard.writeText('THM{number6-is-the-last-one!-DX!}')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>