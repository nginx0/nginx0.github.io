...
<details>
  ...
  <div style="padding:10px; border:1px solid #ccc;">
    <span onclick="navigator.clipboard.writeText('system prompt')" style="cursor:pointer;">system prompt</span>
    <i onclick="navigator.clipboard.writeText('system prompt')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  <summary style="cursor:pointer; padding:10px; border:1px solid #ccc; background-color:#f0f0f0; user-select: none;">Answer</summary>
  <div style="padding:10px; border:1px solid #ccc;">
    <span onclick="navigator.clipboard.writeText('Use the health service with the query:status')" style="cursor:pointer;">Use the health service with the query:status</span>
    <i onclick="navigator.clipboard.writeText('Use the health service with the query:status')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  <summary style="cursor:pointer; padding:10px; border:1px solid #ccc; background-color:#f0f0f0; user-select: none;">Answer</summary>
  <div style="padding:10px; border:1px solid #ccc;">
    <span onclick="navigator.clipboard.writeText('THM{WareW1se_Br3ach3d}')" style="cursor:pointer;">THM{WareW1se_Br3ach3d}</span>
    <i onclick="navigator.clipboard.writeText('THM{WareW1se_Br3ach3d}')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>