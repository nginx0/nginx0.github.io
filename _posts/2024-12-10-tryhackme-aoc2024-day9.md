...
media_subpath: /images/tryhackme_aoc2024_day9/
image:
  path: banner.png
---
...
![](risk_register.gif){: width="1140" height="420"}
...
<details>
  ...
  <div style="padding:10px; border:1px solid #ccc;">
    <span onclick="navigator.clipboard.writeText('Governance, Risk, and Compliance')" style="cursor:pointer;">Governance, Risk, and Compliance</span>
    <i onclick="navigator.clipboard.writeText('Governance, Risk, and Compliance')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  <summary style="cursor:pointer; padding:10px; border:1px solid #ccc; background-color:#f0f0f0; user-select: none;">Answer</summary>
  <div style="padding:10px; border:1px solid #ccc;">
    <span onclick="navigator.clipboard.writeText('THM{R15K_M4N4G3D}')" style="cursor:pointer;">THM{R15K_M4N4G3D}</span>
    <i onclick="navigator.clipboard.writeText('THM{R15K_M4N4G3D}')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>