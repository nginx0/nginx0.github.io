...
media_subpath: /images/tryhackme_aoc2024_day23/
image:
  path: banner.png
---
...
<details>
  ...
  <div style="padding:10px; border:1px solid #ccc;">
    <span onclick="navigator.clipboard.writeText('fluffycat12')" style="cursor:pointer;">fluffycat12</span>
    <i onclick="navigator.clipboard.writeText('fluffycat12')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  <summary style="cursor:pointer; padding:10px; border:1px solid #ccc; background-color:#f0f0f0; user-select: none;">Answer</summary>
  <div style="padding:10px; border:1px solid #ccc;">
    <span onclick="navigator.clipboard.writeText('THM{do_not_GET_CAUGHT}')" style="cursor:pointer;">THM{do_not_GET_CAUGHT}</span>
    <i onclick="navigator.clipboard.writeText('THM{do_not_GET_CAUGHT}')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>