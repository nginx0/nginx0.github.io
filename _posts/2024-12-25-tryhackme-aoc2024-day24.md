...
media_subpath: /images/tryhackme_aoc2024_day24/
image:
  path: banner.png
---
...
![](wireshark1.png){: width="2956" height="1461"}
...
![](wireshark6.png){: width="2957" height="1464"}
...
Following the challenge task given, use the command below to retrieve the flag
...
<details>
  ...
  <div style="padding:10px; border:1px solid #ccc;">
    <span onclick="navigator.clipboard.writeText('THM{Ligh75on-day54ved}')" style="cursor:pointer;">THM{Ligh75on-day54ved}</span>
    <i onclick="navigator.clipboard.writeText('THM{Ligh75on-day54ved}')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
