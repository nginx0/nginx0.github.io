---
title: "TryHackMe: Advent Of Cyber 2025 Day 2 (Phishing - Merry Clickmas)"
categories: [TryHackMe]
tags: [phishing, advent of cyber]
render_with_liquid: false
media_subpath: /images/tryhackme_aoc2025_day2/
image:
  path: banner.png
---
...
[![TryHackMe Room Link](header.svg){: width="1200" height="407" }](https://tryhackme.com/room/phishing-aoc2025-h2tkye9fzU)
...
![](social.jpg){: width="6397" height="3734"}
...
<a href="https://github.com/nginx0/nginx0.github.io/tree/main/images/tryhackme_aoc2025_day2/day02-1764695616249.zip
" download style="
  display: inline-flex;
  align-items: center;
  gap: 8px;
...
- **From address** We know that the guys at the toy factory communicate regularly with Flying Deer, the shipping company, so we will use `updates@flyingdeer.thm` as the source email address
- **From name** Let’s use the name `Flying Deer`
- **Username for open-relay** We will leave it blank and just hit `Enter`
- **Password for open-relay** We will leave it blank and just hit `Enter`
- **SMTP email server address** We will deliver directly to the TBFC mail server by entering `MACHINE_IP`
- **Port number for the SMTP server** We leave the default value of `25` and just hit Enter
...
- **Send the message as HTML or plain** We will keep the default choice of plaintext and just hit `Enter`
...
<details>
  ...
  <div style="padding:10px; border:1px solid #888; background-color:#333; color:#fff;">
    <span onclick="navigator.clipboard.writeText('unranked-wisdom-anthem')" style="cursor:pointer;">unranked-wisdom-anthem</span>
    <i onclick="navigator.clipboard.writeText('unranked-wisdom-anthem')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>
...
<details>
  ...
  <div style="padding:10px; border:1px solid #888; background-color:#333; color:#fff;">
    <span onclick="navigator.clipboard.writeText('1984000')" style="cursor:pointer;">1984000</span>
    <i onclick="navigator.clipboard.writeText('1984000')" style="float:right; cursor:pointer; font-size:16px;">&#x1F4C4;</i>
  </div>
</details>